...
option.auto_bin_max = 16;
 ...
 bins BURTS_SIZE_1BYTE = {3'h0};
 bins BURTS_SIZE_2BYTE = {3'h1};
 bins BURTS_SIZE_4BYTE = {3'h2};
 bins BURTS_SIZE_8BYTE = {3'h3};
 bins BURTS_SIZE_16BYTE = {3'h4};
 bins BURTS_SIZE_32BYTE = {3'h5};
 bins BURTS_SIZE_64BYTE = {3'h6};
 bins BURTS_SIZE_128BYTE = {3'h7};
}
 CP_BURST_TYPE : coverpoint tx.burst_type{
 bins FIXED_BURST = {FIXED};
 bins INCR_BURST = {INCR};
 bins WRAP_BURST = {WRAP};
 illegal_bins ILL = {RSVD_BURST};
}
 CP_RESP : coverpoint tx.respQ[0]{
 bins OKAY = {OKAY};
 bins EXOKAY = {EXOKAY};
 bins SLVERR = {SLVERR};
 bins DECERR = {DECERR};
